  ...
  return (
    <>
      <div className="flex font-readex flex-col justify-center items-center pt-10 gap-4">
        <img src={letter} alt="Letter" className="h-[12rem]"/>
        <h1 className="text-2xl font-bold px-4 text-center">You will receive the letter soon</h1>
